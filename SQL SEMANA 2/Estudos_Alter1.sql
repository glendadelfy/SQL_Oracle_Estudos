...
--ALTER TABLE T_UNV_DISCIPLINA 
-- MODIFY REF_BIBLIOGRAFICA LONG VARCHAR;
 
--ALTER TABLE T_UNV_DISCIPLINA 
-- MODIFY METODOLOGIA LONG VARCHAR;

DROP TABLE T_UNV_PROFESSOR_DISCIPLINA;

--DROP TABLE DISCENTE;

--DROP TABLE T_UNV_CURSO;

DROP TABLE T_UNV_ALUNO_TURMA;

DROP TABLE T_UNV_PROFESSOR_TURMA;
